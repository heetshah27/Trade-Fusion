...
export default function Backtest() {
  ...
  const { data: selectedSession, isLoading: detailLoading } = trpc.backtest.getSession.useQuery({ id: selectedId ?? 0 }, { enabled: selectedId !== null });
