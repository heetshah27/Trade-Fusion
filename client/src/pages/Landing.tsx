...
function Brand() {
  return (
    <div className="flex items-center gap-2.5">
      <div className="relative grid h-9 w-9 place-items-center overflow-hidden rounded-xl bg-[#101e38] shadow-[0_10px_24px_oklch(0.45_0.18_250_/_0.28)] ring-1 ring-blue-200/[0.15]">
        <span className="absolute h-5 w-px bg-red-400" />
        <span className="absolute top-[7px] h-4 w-[5px] rounded-[1px] bg-emerald-400 shadow-[0_0_11px_rgba(74,222,128,0.45)]" />
        <span className="absolute bottom-[7px] h-[5px] w-[5px] rounded-[1px] bg-red-400" />
      </div>
...
function WorkspacePreview() {
  return (
    <div className="relative mx-auto mt-14 max-w-6xl px-1 sm:px-4">
      ...
      <div className="relative overflow-hidden rounded-[1.6rem] border border-blue-200/[0.15] bg-[#08152b] p-2 shadow-[0_36px_95px_rgba(0,0,0,0.48)] sm:p-3">
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#061023] text-white">
      ...
      <header className="relative z-20 mx-auto flex h-20 max-w-7xl items-center justify-between px-5 lg:px-8">
        <Brand />
        <nav className="hidden items-center gap-7 text-sm text-slate-400 md:flex"><a className="transition-colors hover:text-white" href="#features">Features</a><a className="transition-colors hover:text-white" href="#how-it-works">How it works</a><a className="transition-colors hover:text-white" href="#security">Privacy</a></nav>
        <Link href={appRoutes.journal} className="hidden rounded-xl bg-[oklch(0.66_0.18_250)] px-4 py-2.5 text-sm font-semibold text-white shadow-[0_10px_24px_oklch(0.45_0.18_250_/_0.35)] transition hover:bg-[oklch(0.72_0.18_250)] md:inline-flex">Get started <ArrowRight className="ml-2 h-4 w-4" /></Link>
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-5 pb-20 pt-20 text-center sm:pb-28 sm:pt-24 lg:px-8 lg:pt-28">
        <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-blue-300/[0.15] bg-blue-400/[0.08] px-3 py-1.5 font-mono text-[9px] uppercase tracking-[0.16em] text-blue-200"><Sparkles className="h-3.5 w-3.5" /> A private trading review system</div>
        <h1 className="mx-auto mt-7 max-w-5xl text-4xl font-semibold tracking-[-0.065em] text-white sm:text-6xl lg:text-7xl">Turn every execution into <span className="bg-gradient-to-r from-blue-300 via-blue-400 to-sky-300 bg-clip-text text-transparent">your next edge.</span></h1>
        <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-slate-400 sm:text-lg">Trade Fusion brings your journal, performance review, and economic calendar into one secure workspace built for deliberate traders.</p>
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row"><Link href={appRoutes.journal} className="inline-flex h-12 items-center justify-center rounded-xl bg-[oklch(0.66_0.18_250)] px-6 font-semibold text-white shadow-[0_14px_30px_oklch(0.45_0.18_250_/_0.38)] transition hover:bg-[oklch(0.72_0.18_250)]">Get started free <ArrowRight className="ml-2 h-4 w-4" /></Link><a href="#features" className="inline-flex h-12 items-center justify-center rounded-xl border border-white/[0.11] bg-white/[0.035] px-6 font-semibold text-slate-200 transition hover:bg-white/[0.08]">Explore the workspace <ChevronRight className="ml-1 h-4 w-4" /></a></div>
        <div className="mt-7 flex flex-wrap justify-center gap-x-5 gap-y-2 text-xs text-slate-500"><span className="inline-flex items-center gap-1.5"><CheckCircle2 className="h-3.5 w-3.5 text-blue-300" />Private account workspace</span><span className="inline-flex items-center gap-1.5"><CheckCircle2 className="h-3.5 w-3.5 text-blue-300" />Cloud-synced journal</span><span className="inline-flex items-center gap-1.5"><CheckCircle2 className="h-3.5 w-3.5 text-blue-300" />Live market calendar</span></div>
        <WorkspacePreview />
      </section>
