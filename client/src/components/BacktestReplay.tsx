...
import { BoxSelect, Calculator, ChevronLeft, ChevronRight, CirclePause, CirclePlay, Crosshair, Layers3, Maximize2, Minimize2, MousePointer2, Plus, StepForward, Target, Trash2, TrendingUp, X } from "lucide-react";
